...
export default function OwnerApp(){
  ...
  return <main className="real-owner-page owner-app-shell" dir="rtl"><WebMcpTools onChanged={load}/><header className="owner-real-header"><button className="menu-button" onClick={()=>setMenu(true)} aria-label="فتح القائمة"><Menu/></button><DorniBrand/><span className="owner-header-spacer" aria-hidden="true"/></header>
