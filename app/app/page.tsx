...
type Me={user:{id:string;phone:string|null;email:string|null};profile:{account_status:string};vehicles:Vehicle[];reports:Report[];contacts:unknown[];preferences:{primary_channel:string}};
...
export default function OwnerApp(){
  ...
  async function createTicket(){if(await post("/api/support",{category:"GENERAL",...ticket})){setTicket({subject:"",description:""});setNotice("تم فتح تذكرة دعم، نتابعها معاك من داخل الحساب");}}
