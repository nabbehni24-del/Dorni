...
export default function OwnerApp(){
  ...
  return <main className="real-owner-page owner-app-shell" dir="rtl"><WebMcpTools onChanged={load}/><header className="owner-real-header"><button className="menu-button" onClick={()=>setMenu(true)} aria-label="فتح القائمة"><Menu/></button><DorniBrand/><div><button onClick={logout} aria-label="تسجيل الخروج"><LogOut/></button></div></header>
